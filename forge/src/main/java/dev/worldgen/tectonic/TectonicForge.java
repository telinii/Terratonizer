...
public class TectonicForge {
    ...
    private void registerDensityFunctionTypes(final RegisterEvent event) {
        event.register(Registries.DENSITY_FUNCTION_TYPE, helper -> helper.register("config", ConfigConstant.CODEC_HOLDER.codec()));
        event.register(Registries.DENSITY_FUNCTION_TYPE, helper -> helper.register("config_noise", ConfigNoise.CODEC_HOLDER.codec()));
    }
